  ...
  content: [
      ...
      },
      {
          columns: [
              ...
              {
                  text: 'N° :be147 ',style :'textSize',alignment:'center'
              },
      ...
      '\n','\n', 
      {
          columns: [
              ...
              {
                  text: 'Adresse  : ',style :'textSize',alignment:'center'
              },
              {
                  text: this.fournisseurObj.adresse,style : 'Size'
              }
          ]
      },
      {
        columns:[
          ...
          {
            text: 'GSM :  ',style :'textSize',alignment:'center'
          },
          {

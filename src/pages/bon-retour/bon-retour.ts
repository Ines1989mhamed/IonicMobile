...
body.unshift(['N°', 'Designation', 'Quantité']);
  ...
  content: [
      {
          ...
          {text:'Bon De Retour ' , style: 'center',color : '#B22222'},
      ...
      },
      {
          columns: [
              ...
              { text: 'N° :BR ',style :'textSize',alignment:'center' },             
          ]
      },
      '\n','\n', 
      {
          columns: [
              ...
              { text: this.clientObj.client,style : 'Size'},
              { text: 'Adresse de livraison :  ',style :'textSize',alignment:'right'},
              { text: this.clientObj.adresse,style : 'Size'},
          ]
      },'\n', 
      {
        columns:[
          { text: "Transporteur : ",style:'textSize' },
          { text: this.clientObj.transporteur,style:'Size'},
          { text: 'Telephone :  ',style :'textSize',alignment:'center'},
          { text: this.clientObj.telephone,style : 'Size'},
          { text: 'Voiture :  ',style :'textSize',alignment:'right'},
          { text: this.clientObj.voiture,style : 'Size'}
        ]
      },
      {
        columns: [
          {text: 'Equipe Technique : ', style: 'textSize'},
          { text: this.clientObj.equipeTechn,style:'Size'},
          {text: 'Date début', style: 'textSize',alignment:'center'}, 
          {text: this.clientObj.dateDeb, style: 'Size'},
          {text: 'Date fin', style: 'textSize',alignment:'right'}, 
          {text: this.clientObj.dateFin, style: 'Size'}
        ]
      },'\n','\n',
      {
  ...
  {
    this.makePdf();
    this.dataService.addFicheRetour(this.Fiche).subscribe(
      () => {
